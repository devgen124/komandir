...
abstract class NodeAsProductAttribute
{
     ...
     * @return string
     */
    public static function getTaxonomyName($name, $prefix, $sessionKey)
    {
     ...
     * @param int    $termId
     */
    public static function saveValueToProduct($productId, $taxName, $termId)
    {
        /*
        ...
        */
        ...
        Term::setObjectTerms($productId, (int) $termId, $taxName);
    }
     ...
     * @return bool
     */
    public static function isProductAttribute($taxonomy)
    {
