...
class ParserXmlOrders
{
    ...
    public function parse($filename)
    {
        ...
        while ($reader->read()) {
             ...
             * @param \SimpleXMLElement $order       'Документ' node object.
             */
    ...
    private function resolveResultStatus($requisites, $element, $order)
    {
        ...
        if (
            !SettingsHelper::isEmpty('handle_get_order_status_change_if_cancelled')
            && isset($requisites['Отменен'])
            && $requisites['Отменен'] === 'true'
        ) {
