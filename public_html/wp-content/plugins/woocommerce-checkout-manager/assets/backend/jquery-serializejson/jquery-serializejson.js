...
(function (factory) {
	...
	$.serializeJSON = {
		...
		setupOpts: function (options) {
			...
			return {
				checkboxUncheckedValue: optWithDefault(
					'checkboxUncheckedValue'
				),
				...
				skipFalsyValuesForTypes: optWithDefault(
					'skipFalsyValuesForTypes'
				),
				skipFalsyValuesForFields: optWithDefault(
					'skipFalsyValuesForFields'
				),
				...
				useIntKeysAsArrayIndex: optWithDefault(
					'useIntKeysAsArrayIndex'
				),
			};
		},
