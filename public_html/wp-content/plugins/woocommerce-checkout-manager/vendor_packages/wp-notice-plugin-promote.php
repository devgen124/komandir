...
if ( class_exists( 'QuadLayers\\WP_Plugin_Table_Links\\Load' ) ) {
	...
	define( 'WOOCCM_PROMOTE_CROSS_INSTALL_1_URL', 'https://quadlayers.com/portfolio/woocommerce-direct-checkout/?utm_source=wooccm_admin' );
	/**
	 * Notice cross sell 2
	 */
	...
	define( 'WOOCCM_PROMOTE_CROSS_INSTALL_2_URL', 'https://quadlayers.com/portfolio/perfect-woocommerce-brands/?utm_source=wooccm_admin' );
	...
	new \QuadLayers\WP_Notice_Plugin_Promote\Load(
		...
		array(
			array(
				...
				'notice_description' => esc_html__( 'Could you please give it a 5-star rating on WordPress?. Your feedback will boost our motivation and help us promote and continue to improve this product.', 'woocommerce-checkout-manager' ),
