...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
        ...
        <fieldset class="edit-account-fieldset">
            ...
            <label class="edit-account-label">
                <input disabled type="tel" name="account_phone" id="account_phone" value="<?php echo WC()->customer->get_billing_phone(); ?>" placeholder="Телефон" />
            </label>
            <a href="#change-phone-number-popup" class="button edit-account-button change-phone-number-link">Изменить номер телефона</a>
        </fieldset>

        <fieldset class="edit-account-fieldset">
            <legend class="edit-account-legend"><?php esc_html_e('Password change', 'woocommerce'); ?></legend>
            <label class="edit-account-label">
