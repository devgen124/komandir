...
require get_template_directory() . '/class-wishlist-cart.php';

$wishlist_cart = new WT_Wishlist_Cart();
...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="woocommerce-custom-cart">
		...
		<ul class="woocommerce-cart-form__contents woocommerce-custom-cart-list">
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<li class="woocommerce-custom-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<div class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
							...
							<button class="product-quantity-btn product-quantity-minus" aria-label="Уменьшить">-
							</button>
						...
						<?php
						$wishlist_cart->render_webtoffee_wishlist_button( $_product );
						?>
		...
		<div class="woocommerce-custom-cart-actions">
			<?php if ( wc_coupons_enabled() ) { ?>
				<div class="coupon">
					<label for="coupon_code" class="screen-reader-text">Промокод:</label> <input type="text"
																								 name="coupon_code"
																								 class="input-text"
																								 id="coupon_code"
																								 value=""
					...
					<button type="submit"
							...
							name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>">Применить
					</button>
			...
			<button type="submit"
					class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?> update-cart"
					name="update_cart"
