...
?>
    ...
    <div class="container">
        ...
        <a class="catalog-slide-backlink"><?= $category->name; ?></a>
        ...
        <div class="woo-attributes-inner">
            <?php foreach ($product_attributes as $product_attribute_key => $product_attribute) : ?>
                <div class="woo-attributes-item woo-attributes-item--<?php echo esc_attr($product_attribute_key); ?>">
                    <div class="woo-attributes-item__label"><?php echo wp_strip_all_tags($product_attribute['label']); ?></div>
                    <div class="woo-attributes-item__value"><?php echo wp_strip_all_tags($product_attribute['value']); ?></div>
                </div>
            <?php endforeach; ?>

            <a class="woo-attributes-show-link" href="<?php echo $product->get_permalink(); ?>">Посмотреть все характеристики</a>
...
<?php
    ...
    function komandir_product_tabs($tabs) {
        if (isset($tabs['description'])) $tabs['description']['title'] = 'О товаре';
        if (isset($tabs['additional_information'])) $tabs['additional_information']['title'] = 'Характеристики';
