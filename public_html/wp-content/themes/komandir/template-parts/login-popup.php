...
<template id="login-send-code"><div class="custom-popup-section login-send-code">
...
<template id="login-pass"><div class="custom-popup-section login-pass">
...
<template id="login-sms"><div class="custom-popup-section login-sms">
    <button class="login-popup-backlink" aria-label="Назад"></button>
...
<template id="login-profile"><div class="custom-popup-section login-profile">
    <h2>Мой профиль</h2>
