...
class WT_Wishlist_Cart {
  
    public function render_webtoffee_wishlist_button($product) {

        global $wt_wishlist_button_style_settings_options, $wt_wishlist_table_settings_options, $wt_wishlist_general_settings_options;
