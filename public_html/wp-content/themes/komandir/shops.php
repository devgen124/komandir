	...
	<div class="container">
		<div class="shops-page-inner">
			<div class="shops-content">
				...
				<p class="shops-text">Время работы с 10:00 до 19:00 (без обеда и выходных)<br>+7-923-299-96-88 (WhatsApp
					и Viber)</p>
				...
				<p class="shops-after-text">Эл. почта: komandir124@mail.ru<br>доставка и сервисное обслуживание:
					+7-950-990-49-00 (WhatsApp и Viber)</p>
			</div>
